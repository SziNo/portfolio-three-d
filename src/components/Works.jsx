        ...
        <div className='relative w-full h-[230px]'>
          ...
          <div className='absolute inset-0 flex justify-center items-end m-3 gap-4 card-img_hover'>
            <div
              ...
              className='black-gradient md:w-16 sm:w-14 w-12 md:h-16 sm:h-14 h-12 rounded-full flex justify-center items-center cursor-pointer hover:translate-y-[-5px] hover:opacity-80 transition duration-300'
            >
              <img
                src={github}
                alt='source code'
            ...
            <div
              ...
              className='white-gradient md:w-16 sm:w-14 w-12 md:h-16 sm:h-14 h-12 rounded-full flex justify-center items-center cursor-pointer hover:translate-y-[-5px] hover:opacity-90 transition duration-300'
            >
              <img
                src={rocket}
                alt='source code'
